  ...
  return (
    <div>
        <Container>
            <Row>
                <Col md="6">
                <img src={require('assets/images/Pages/Landing/eu-easiest-man.jpg')} height="50" className="img-fluid absolute-image" alt="" />

                </Col>
                <Col md="6" className='align-self-center'>
                    <h2 className='my-5'>The best way to send money from <br /> Canada to the Europe.</h2>
                    {[
                        {
                            image: 'send-money',
